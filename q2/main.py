...
if __name__ == "__main__":
    ...
    # Adding Students
    sms.add_student("balamurugan","balamurugan87666@gmail.com")
    sms.add_student("Sanjaykumar","sanjaydeva6338612@gmail.com")
    sms.add_student("Senthilprabhu","sanjaysanjay212004@gmail.com")
